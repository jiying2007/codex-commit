...
Current runtime trust root: Codex Safe Core v4.9.2 at exact commit `f43505e9e34b8da1170aafc72673569183137b04`. `product-contract.json` and the `src/codex-safe-core` gitlink are authoritative; immutable historical schema URLs in examples or older release notes remain provenance records, not a moving dependency.
