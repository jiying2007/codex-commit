...
async function sync() {
  ...
  fs.writeFileSync(lockPath, `${JSON.stringify({ schemaVersion: 1, safeCoreVersion: upstream.manifest.safeCoreVersion, source: upstream.manifest.source, manifestSha256: sha256(upstream.manifestBytes), files: upstream.manifest.files }, null, 2)}\n`);
  verify();
